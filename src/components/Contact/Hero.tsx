    ...
    <section className="relative w-full py-16 md:py-24 overflow-hidden bg-gradient-to-b from-blue-700 to-blue-50/10 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col items-start text-left max-w-4xl">
          ...
          >
            Need Help?<br />You can reach Bluescope With a Message
          </motion.h1>
          ...
          >
           You need help or even need more information about our services? You can reach us with a message. We will get back to you as soon as possible
          </motion.p>
