...
const testimonials = [
  ...
  },
  {
    ...
    isVideo: true,
    videoThumbnail:
      "https://images.pexels.com/photos/7586548/pexels-photo-7586548.jpeg?auto=compress&cs=tinysrgb&w=600",
  },
  {
    id: 3,
    ...
    <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="mb-8 sm:mb-12 md:mb-16">
          <h3 className="text-xs sm:text-sm uppercase tracking-wider text-gray-900 mb-2 sm:mb-4">TESTIMONIALS</h3>
            ...
            <AnimatePresence initial={false}>
              <div className="flex flex-wrap sm:flex-nowrap gap-4 sm:gap-6">
                {getVisibleTestimonials().map((testimonial, index) => (
                  ...
                  >
                    {testimonial.isVideo ? (
                      // Video testimonial - Adjusted for mobile
                      <div className="relative h-64 sm:h-full rounded-lg overflow-hidden">
                        ...
                        <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
                          ...
                          <button
                            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white bg-opacity-80 flex items-center justify-center"
                          ...
                          <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white">
                            ...
                            <p className="text-xs sm:text-sm text-gray-200">{testimonial.position}</p>
                          </div>
                        </div>
                      </div>
                    ) : (
                      // Regular testimonial - Adjusted for mobile
