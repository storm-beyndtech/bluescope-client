...
export default function EventsSection() {
  ...
  const featuredEvents = [
    {
      ...
      image: "https://bluescopeptyltd.club/homelink/wp-content/uploads/2023/10/Event.jpg",
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      location: "Bluescope Headquarters, Sydney",
      date: "25th Oct, 2024",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        ...
        >
          ...
          <p className="mt-6 text-gray-600 text-lg max-w-2xl">
            Unlocking New Horizons: Exclusive Investment Strategies for Building Generational Wealth – Join the Live
            Event.
          </p>
        </motion.div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-6xl font-semibold mb-6 uppercase Poppins">Bluescope <span className="text-blue-600">Society</span></h2>
            <p className="text-lg text-gray-700 mb-8">
              Bluescope Society showcases its dedication to investing in initiatives that enhance the well-being of
              individuals and communities nationwide. We believe in creating lasting impact through strategic
              investments and community engagement.
            </p>
            <div className="flex justify-center">
              <Link to="/about-society" className="inline-flex items-center text-[#1e56ff] font-medium hover:underline">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="flex items-center justify-between mt-12">
          ...
          <div className="flex space-x-2">
            ...
            <button className="w-8 h-8 rounded-full text-gray-500 flex items-center justify-center text-sm">2</button>
            <button className="w-8 h-8 rounded-full text-gray-500 flex items-center justify-center text-sm">3</button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                Bluescope hosts events across the globe, bringing together investors, industry experts, and community
                leaders to discuss the future of wealth building and sustainable investments.
              </p>
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1526778548025-fa2f459cd5ce?q=80&w=2070"
                alt="Global map"
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Subscribe to our newsletter to receive updates on upcoming events, investment insights, and exclusive
            opportunities.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <input
              ...
              className="px-6 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#1e56ff] focus:border-transparent"
            />
            <button className="bg-[#1e56ff] text-white px-6 py-3 rounded-md font-medium hover:bg-blue-600 transition-colors">
              Subscribe
            </button>
          </div>
        </motion.div>
      ...
      {/* CTA */}
      <section className="bg-[#1e56ff] py-16">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-white/80 mb-8">
              Don't miss the opportunity to be part of our exclusive events where we discuss the future of investments
            ...
            >
              Register for Events <ArrowRight className="ml-2 h-4 w-4" />
            </Link>
          </motion.div>
        </div>
      </section>
