    ...
    <section className="relative w-full py-16 md:py-24 overflow-hidden bg-gradient-to-b from-blue-700 to-blue-50/10 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col items-start text-left mb-12 max-w-4xl">
          ...
          >
            Join Our Premier Events & Webinars
          </motion.h1>
          ...
          >
            Explore the future of technology and finance with thought leaders and innovators.
            Our events are designed to inspire, educate, and connect change-makers like you.
          </motion.p>
